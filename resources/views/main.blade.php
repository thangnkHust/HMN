...
<head>
    ...
    {{-- <link rel="stylesheet" href="{{asset('front_page/css/font-awesome.min.css')}}"> --}}
    {{-- <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css"> --}}
    <link rel="stylesheet" href="{{asset('front_page/css/bootstrap.min.css')}}">

    <!-- Css animations  -->
    <link href="{{asset('front_page/css/animate.css')}}" rel="stylesheet">

    <!-- Theme stylesheet, if possible do not edit this stylesheet -->
    <link href="{{asset('front_page/css/style.default.css')}}" rel="stylesheet" id="theme-stylesheet">

    <!-- Custom stylesheet - for your changes -->
    <link href="{{asset('front_page/css/custom.css')}}" rel="stylesheet">
...
<![endif]-->
    ...
    <link rel="shortcut icon" href="{{asset('front_page/img/favicon.ico')}}" type="image/x-icon" />
    <link rel="apple-touch-icon" href="{{asset('front_page/img/apple-touch-icon.png')}}" />
    <link rel="apple-touch-icon" sizes="57x57" href="{{asset('front_page/img/apple-touch-icon-57x57.png')}}" />
    <link rel="apple-touch-icon" sizes="72x72" href="{{asset('front_page/img/apple-touch-icon-72x72.png')}}" />
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('front_page/img/apple-touch-icon-76x76.png')}}" />
    <link rel="apple-touch-icon" sizes="114x114" href="{{asset('front_page/img/apple-touch-icon-114x114.png')}}" />
    <link rel="apple-touch-icon" sizes="120x120" href="{{asset('front_page/img/apple-touch-icon-120x120.png')}}" />
    <link rel="apple-touch-icon" sizes="144x144" href="{{asset('front_page/img/apple-touch-icon-144x144.png')}}" />
    <link rel="apple-touch-icon" sizes="152x152" href="{{asset('front_page/img/apple-touch-icon-152x152.png')}}" />
    <!-- owl carousel css -->

    <link href="{{asset('front_page/css/owl.carousel.css')}}" rel="stylesheet">
    <link href="{{asset('front_page/css/owl.theme.css')}}" rel="stylesheet">
</head>
                    ...
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand home" href="index.html">
                                <img src="{{asset('front_page/img/logo.png')}}" alt="Universal logo" class="hidden-xs hidden-sm">
                                <img src="{{asset('front_page/img/logo-small.png')}}" alt="Universal logo" class="visible-xs visible-sm"><span class="sr-only">Universal - go to homepage</span>
                            </a>
...
_________________________________________________________ -->
    ...
    <script>
        window.jQuery || document.write('<script src="' + "{{asset('front_page/js/jquery-1.11.0.min.js')}}" + '"><\/script>')
    </script>
    <script src="{{asset('front_page/js/bootstrap.min.js')}}"></script>
    {{-- <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/js/bootstrap.min.js"></script> --}}

    <script src="{{asset('front_page/js/jquery.cookie.js')}}"></script>
    <script src="{{asset('front_page/js/waypoints.min.js')}}"></script>
    <script src="{{asset('front_page/js/jquery.counterup.min.js')}}"></script>
    <script src="{{asset('front_page/js/jquery.parallax-1.1.3.js')}}"></script>
    <script src="{{asset('front_page/js/front.js')}}"></script>
